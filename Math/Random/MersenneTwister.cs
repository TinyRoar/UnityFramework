...
namespace TinyRoar.Framework
{
    ...
    /// CSharpCity.Tools.RandomNumberGenerators by http://www.csharpcity.com/
    /// </summary>
    class MersenneTwister : Random
    {
        ...
        public MersenneTwister()
            : this((uint)DateTime.UtcNow.Ticks + (uint)new Random().Next()) /* a default initial Seed is used   */
        {
        }
        ...
        {
            return (float)(this.NextDouble() * maxValue);
        }
